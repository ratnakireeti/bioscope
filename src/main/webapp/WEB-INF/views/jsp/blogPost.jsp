	...
	<div class="row">
		...
		<div class="col-sm-9 col-xs-12">
			...
			<div id="${requestedPost.slug}-block" class="blog-post">
				...
				<p id="${requestedPost.slug}-date" class="blog-date text-muted">${requestedPost.printPostDate()}
					GMT</p>
				...
				<ul class="pager">
					<c:choose>
						<c:when test="${previousPost != null}">
							<li class="previous"><a
								href="${contextPath}/blog/${previousPost.slug}">&larr;
									Previous Post</a></li>
						</c:when>
						<c:otherwise>
							<li class="previous disabled"><a disabled="true">&larr;
									Previous Post</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${nextPost != null}">
							<li class="next"><a
								href="${contextPath}/blog/${nextPost.slug}">Next Post &rarr;</a></li>
						</c:when>
						<c:otherwise>
							<li class="next disabled"><a disabled="true">Next Post
									&rarr;</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
