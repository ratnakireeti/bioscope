...
<link rel="stylesheet"
	...
	type="text/css" />
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/tag-it/2.0/css/jquery.tagit.css"
	type="text/css" />
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-9 col-md-8 col-xs-12">
			...
			<form:form id="blogPostForm" cssClass="form-horizontal" method="post"
					...
					<div class="row">
						...
						<div class="form-group">
							...
							<div div class="col-lg-9">
								<form:input id="titleInput" path="title" cssClass="form-control"
									cssErrorClass="error" maxlength="200" value="${blogPost.title}"
									onkeypress="updateSlug()" onkeyup="updateSlug()" />
							</div>
							<form:errors path="title"
								cssClass="help-inline spring-form-error" element="span" />
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<form:input id="slugInput" path="slug" cssClass="form-control"
									cssErrorClass="error" maxlength="100" value="${blogPost.slug}" />
							</div>
							<form:errors path="slug" cssClass="help-inline spring-form-error"
								element="span" />
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<form:textarea id="markupInput" path="content"
									cssClass="form-control" cssErrorClass="error" rows="10"
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<input id="tagInputHidden" name="tagString" type="text"
									class="form-control" value="${tagString}" style="display: none" />
								<ul id="tagInput" class="tag-input-control"></ul>
							</div>
							<form:errors path="tags" cssClass="help-inline spring-form-error"
								element="span" />
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<form:select id="statusSelect" size="1" path="status"
									cssClass="form-control" value="${blogPost.status}">
						...
						<!--Enable Comments-->
						<label class="col-lg-offset-2 checkbox-inline"
							for="enableCommentsCheck"> <form:checkbox
								id="enableCommentsCheck" path="enableComments"
								value="${blogPost.enableComments}" /> Enable Comments
						</label>
						<form:errors path="enableComments"
							cssClass="help-inline spring-form-error" element="span" />

						<!--Enable Pegdown-->
						<label class="checkbox-inline" for="enablePegdownCheck"> <form:checkbox
								id="enablePegdownCheck" path="enablePegdown"
								value="${blogPost.enablePegdown}" /> <%--<input type="checkbox" id="enablePegdownCheck" name="enablePegdown" checked="checked" />                    --%>
							Enable Pegdown
						</label> <br />
						<br />
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-9">
								...
								<a id="resetButton" class="btn btn-default">Reset</a> <a
									id="canceltButton" class="btn btn-default"
									href="${contextPath}/admin/blog/cancel">Cancel</a>
							</div>
						</div>
...
<script type="text/javascript"
	src="https://cdnjs.cloudflare.com/ajax/libs/tag-it/2.0/js/tag-it.min.js"></script>
