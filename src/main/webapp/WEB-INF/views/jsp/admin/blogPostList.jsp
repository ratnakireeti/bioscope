...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-9 col-xs-12">
			...
			<a href="${contextPath}/admin/blog/new"><button
					class="btn btn-info">
					...
					<table class="table table-striped">
						...
						<c:forEach items="${postList}" var="post">
							<tr>
								...
								<td><a href="${contextPath}/admin/blog/${post.postId}"
									title="Edit blog post."><button class="btn btn-info">
											<span class="glyphicon glyphicon-edit"></span>
										</button></a></td>
								<td><a onclick="deletePost(${post.postId})"
									title="Delete blog post."><button class="btn btn-danger">
