...
<div class="well-lg alert-info">
	...
	<ul class="list-unstyled">
		...
		<li>More details <a href="https://github.com/sirthias/pegdown">here</a>.
		</li>
	...
	<h3>Status</h3>
	<p>Posts with a status of "Draft" will not show up on the main
		page, but can be accessed by direct URL link. Posts with a status of
		"Live" can be accessed by any means.</p>

	<h3>Comments</h3>
	<p>Check "Enable Comments" to allow commenting in posts. Posts that
		do not have this option checked will not show the commenting tools in
		the post details, and will not show post counts in summary.</p>
